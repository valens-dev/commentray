    ...
    <div className="lt-stream">
      <div className="lt-inner-container">
        <div className="lt-preview-screen">
          <img
            className="lt-preview-image"
            id="stream-placeholder"
            alt="stream-placeholder"
            src={streamPlaceholder}
          />
          <div className="lt-screen-buttons">
            <IconButton className="lt-exit-fullscreen">
              <img src={exitFullscreenIcon} alt="exit fullscreen" />
            </IconButton>
            <IconButton className="lt-subtitles">
              <img src={subtitlesIcon} alt="show subtitles" />
            </IconButton>
            <IconButton className="lt-more">
        ...
        <div className="lt-audio-control">
          <ButtonGroup variant="outlined" aria-label="Audio control">
            <IconButton className="small">
              <img src={back15SecondsIcon} alt="back 15 seconds button" />
            </IconButton>
            <IconButton className="small">
              <img src={previousIcon} alt="previous stream button" />
            </IconButton>
            <IconButton className="large">
              <img src={pauseIcon} alt="pause button" />
            </IconButton>
            <IconButton className="small">
              <img src={nextIcon} alt="next stream button" />
            </IconButton>
            <IconButton className="small">
              <img src={front15SecondsIcon} alt="front 15 seconds button" />
            </IconButton>
          </ButtonGroup>
        </div>
        <ContinuousSlider />
